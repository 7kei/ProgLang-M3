...
class Enemy:
    ...
    try:
        animation = [pygame.image.load(f'D:/Downloads/A.Y 2024 - 2025/1st Term/CS121/M2 Summative/github repo ni keian/ProgLang-M3/Sprites (assets)/bat/fly ({i}).png') for i in range(1, 4)]
